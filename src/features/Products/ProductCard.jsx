...
const ProductCard = ({ product }) => {
  return (
    <div 
      style={{
      ...
      }} className="w-full rounded-[36px] border border-white/10 backdrop-blur-md flex flex-col pt-32 pb-6 px-6 relative shadow-xl overflow-visible group select-none">
        ...
        <img 
          src={product.image} 
          alt={product.title} 
          className="max-w-full max-h-full object-contain drop-shadow-[0_25px_15px_rgba(0,0,0,0.5)] transform group-hover:scale-[1.05] transition-transform duration-500 ease-out"
        />
      </div>
