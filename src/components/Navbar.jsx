...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 font-['Inter'] select-none">
      ...
      {/* ─── MAIN BAR ─── */}
      <div className="w-full h-[80px] md:h-[100px] lg:h-[120px] flex items-center justify-between px-6 md:px-10 lg:px-14 max-w-[1600px] mx-auto">
        ...
        <a href="#home" className="flex items-center gap-3 flex-shrink-0 no-underline">
          ...
          />
          <span className="text-[22px] md:text-[26px] lg:text-[28px] font-black text-white leading-none tracking-tight">
            Planto.
          </span>
        </a>

        {/* ── CENTER: Nav Links (desktop) ── */}
        <div className="hidden md:flex items-center gap-8 lg:gap-12 xl:gap-14 absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2">

          <a href="#home"
            className="text-white/75 hover:text-white text-[15px] lg:text-[16px] font-medium transition-colors duration-200 whitespace-nowrap">
            Home
          </a>

          {/* Dropdown */}
          <div className="relative group">
            <button className="flex items-center gap-1 text-white/75 hover:text-white text-[15px] lg:text-[16px] font-medium transition-colors duration-200 whitespace-nowrap bg-transparent border-none cursor-pointer p-0">
              Plants Type
              <ChevronDown
                size={13}
        ...
        {/* ── RIGHT: Icons ── */}
        <div className="flex items-center gap-8 md:gap-9 flex-shrink-0">
          ...
          >
            <img src="/assets/search-icon.png" alt="" className="w-[19px] h-[19px]" />
          </button>
          ...
          <button
            ...
            className="flex flex-col items-end justify-center gap-[5px] text-white/75 hover:text-white transition-colors duration-200 bg-transparent border-none cursor-pointer p-0 w-6"
          >
            <span className="block h-[2.5px] w-6 bg-current rounded-sm transition-all duration-200" />
            <span className={`block h-[2.5px] bg-current rounded-sm transition-all duration-200 ${isOpen ? "w-6" : "w-3.5"}`} />
          </button>
